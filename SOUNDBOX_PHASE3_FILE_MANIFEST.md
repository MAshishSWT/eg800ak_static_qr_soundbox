# EG800AK Static QR UPI Soundbox Phase 3 Package Manifest

This package extends the approved Phase 2 BSP/HAL package with file-system storage, A/B configuration slots, CRC validation, defaults, and an external SPI NOR abstraction.
