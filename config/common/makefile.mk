...
ifneq (,$(findstring 1603,${ASR_PLATFORM}))
	GCC_STDLIB_TARGET_PATH=thumb\v7\nofp
	MPU_FLAG=-mcpu=cortex-r4 -mfloat-abi=soft
else
	GCC_STDLIB_TARGET_PATH=thumb\v7+fp\softfp
	MPU_FLAG=-mcpu=cortex-r5 -mfloat-abi=softfp -mfpu=vfpv3-d16
endif
GCC_VERSION:=9.2.1
...
#-------------------------------------------------------------------------------
SFLAGS:=-c -mlong-calls  ${MPU_FLAG} -mlittle-endian -mthumb -mthumb-interwork  -Wall -Os
CFLAGS:=-c -MMD -mlong-calls  ${MPU_FLAG} -mlittle-endian -mthumb -mthumb-interwork  -Wall -ffunction-sections -fdata-sections $(FNO_BUILTIN_FLAGS) -D__OCPU_COMPILER_GCC__ -D_WANT_USE_LONG_TIME_T -std=c99 -g -Os
CPPFLAGS:=-c -MMD -mlong-calls  ${MPU_FLAG} -mlittle-endian -mthumb -mthumb-interwork  -Wall -ffunction-sections -fdata-sections $(FNO_BUILTIN_FLAGS) -D__OCPU_COMPILER_GCC__ -D_WANT_USE_LONG_TIME_T -std=c++11  -g -Os
