...
static void fs_test(void * argv)
{
	...
	//系统默认customer_fs格式化为U盘，不需要qextfs_init，可以直接使用
	//将ext_reserved分区，起始地址为0xF4000，大小为0x8000的区域格式化为文件系统，盘符为C
	ret = qextfs_init('C', "ext_reserved", 1, port_index, 0xF4000, 0x8000);
