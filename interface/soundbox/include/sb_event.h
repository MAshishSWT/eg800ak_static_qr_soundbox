...
typedef enum {
    ...
    SB_EVENT_FACTORY_READY,
    SB_EVENT_FACTORY_COMMAND,
    SB_EVENT_FACTORY_COMMAND_DONE,
    SB_EVENT_FACTORY_COMMAND_REJECTED,
    SB_EVENT_SERIAL_READY,
    SB_EVENT_SERIAL_COMMAND,
    SB_EVENT_SMS_READY,
    SB_EVENT_SMS_COMMAND,
    SB_EVENT_SMS_FAULT
} sb_event_id_t;
