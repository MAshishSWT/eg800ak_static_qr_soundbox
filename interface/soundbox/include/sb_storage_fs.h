...
/* Use flat files under U:/ for maximum compatibility with the EG800AK LFS mount
 * created by the Quectel boot flow before the customer app starts.
 */
#define SB_STORAGE_DISK_TEXT          "U:"
#define SB_STORAGE_ROOT_DIR           "U:/"
#define SB_STORAGE_CONFIG_DIR         "U:/"
#define SB_STORAGE_CONFIG_SLOT_A_PATH "U:/sb_cfg_a.bin"
#define SB_STORAGE_CONFIG_SLOT_B_PATH "U:/sb_cfg_b.bin"
#define SB_STORAGE_CONFIG_TEMP_PATH   "U:/sb_cfg_tmp.bin"
