...
struct mbedtls_ssl_config {
	...
	unsigned int cert_disable_tm_chk: 1;
...
#ifdef QUECTEL_MBEDTLS_SUPPORT
void mbedtls_ssl_conf_cert_time_vality_check( mbedtls_ssl_config *conf, int disable_chk);
void* mbedtls_ssl_get_bio(mbedtls_ssl_context *ssl);
int mbedtls_ssl_get_retransmit_timeout(mbedtls_ssl_context *ssl);
#endif/*QUECTEL_MBEDTLS_SUPPORT*/
#ifdef __cplusplus
}
#endif
