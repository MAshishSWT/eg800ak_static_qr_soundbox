...
#ifdef QUECTEL_MBEDTLS_SUPPORT
void mbedtls_debug_print_val( const mbedtls_ssl_context *ssl, int level,
								     const char *func, int line,
									 const char *text, int val );

void mbedtls_debug_print_str( const mbedtls_ssl_context *ssl, int level,
							  const char *func, int line,
							  const char *text, char *val );
							  
#define MBEDTLS_SSL_DEBUG_VAL( level, text, val )                \
    mbedtls_debug_print_val( ssl, level, __FUNCTION__, __LINE__, text, val )

#define MBEDTLS_SSL_DEBUG_STR( level, text, str )                \
    mbedtls_debug_print_str( ssl, level, __FUNCTION__, __LINE__, text, str)
#endif/*QUECTEL_MBEDTLS_SUPPORT*/
