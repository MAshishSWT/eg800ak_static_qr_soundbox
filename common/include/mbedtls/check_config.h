...
#ifdef QUECTEL_MBEDTLS_GEU_RANDOM_SUPPORT
#if !defined(QUECTEL_MBEDTLS_SUPPORT) || !defined(MBEDTLS_ENTROPY_HARDWARE_ALT)
#error \
    "mbedtsl support hardware random numbers, need set QUECTEL_MBEDTLS_SUPPORT && MBEDTLS_ENTROPY_HARDWARE_ALT"
#endif
#endif/*QUECTEL_MBEDTLS_GEU_RANDOM_SUPPORT*/
