...
//Add error codes for ssl_net_connect_timeout use
...
void SSLCtxDeinitTimeout(SSLCtx * sslCtx, int timeout_ms);//wendy.wu@20241112 fix bug FAE-138352 Add total timeout interface 

int SSLHandshake(SSLCtx * sslCtx, int timeout_ms);

int SSLHandshakeEx(SSLCtx * sslCtx, Time* timer);//wendy.wu@20241112 fix bug FAE-138352 Add total timeout interface 
