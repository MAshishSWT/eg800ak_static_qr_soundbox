 ...
 * Name:  ql_lcd_write
 *
 * Description: lcd异步刷新 仅1609支持此接口
 *
 * Parameters:  
 *              
 * Returns:     
 ...
 *
 ***********************************************************************/
int ql_lcd_write(unsigned char *pbuffer, unsigned short start_x, unsigned short start_y, unsigned short end_x, unsigned short end_y);
/***********************************************************************
 *
 * Name:  ql_lcd_osd_config
 *
 * Description: 配置lcd的背景图层，仅1609支持
 *
 * Parameters:  
 *              
 * Returns:     
 ...
 *
 ***********************************************************************/
int ql_lcd_osd_config(unsigned char *pbuffer, unsigned short start_x, unsigned short start_y, unsigned short end_x, unsigned short end_y);
