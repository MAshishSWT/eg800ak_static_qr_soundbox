...
typedef enum PIN_DRIVE_LEVEL_ENUM {
	GPIO_DRV_LEVEL_VERY_SLOW = 0,
	GPIO_DRV_LEVEL_SLOW, 
	GPIO_DRV_LEVEL_MED,
	GPIO_DRV_LEVEL_FAST
}QL_PIN_DRIVE_LEVEL_E;
...
/*****************************************************************
* Function:     ql_pin_set_func 
* 
 Description:    设置pin脚的复用功能
*               
* Parameters:
*            gpio_num:
*            fun_sel:0-7,对应pinmux表的
* Return:        
*               0 , succeed.
*              -1,  error.
*****************************************************************/

int ql_pin_set_func(GPIO_PIN_NUMBER_E gpio_num, unsigned char func_sel);
...
/*****************************************************************
* Function:     ql_sfp_eint_register 
* 
* Description: Notice：注册特殊功能引脚唤醒中断
*                
* Parameters:
*              gpio_num 		:	gpio号
*			   wakeup_eint_cb	:	唤醒中断回调函数

* Return:        
*               0 , the function execution succeed.
*               -1, the parameter error.
*****************************************************************/
int ql_sfp_eint_register(GPIO_PIN_NUMBER_E gpio_num, void *wakeup_eint_cb);
/*****************************************************************
* Function:     ql_sfp_eint_unregister 
* 
* Description: 	Notice：注销特殊功能引脚唤醒中断
*                
* Parameters:	gpio_num :	gpio号
*            	
* Return:        
*               0 , the function execution succeed.
*               -1, the parameter error.
*****************************************************************/
int ql_sfp_eint_unregister(GPIO_PIN_NUMBER_E gpio_num);

/*****************************************************************
* Function:     ql_gpio_set_drv_level 
* 
* Description: 	Notice：配置对应GPIO的驱动能力等级,需要在GPIO初始化
*						(ql_gpio_init & ql_gpio_set_direction)之后调用
*					     
*                
* Parameters:	gpio_num :	gpio号
*            	
...
*               -1, the parameter error.
*****************************************************************/
int ql_gpio_set_drv_level(GPIO_PIN_NUMBER_E gpio_num, QL_PIN_DRIVE_LEVEL_E drive_level);

/*****************************************************************
* Function:     ql_gpio_get_drv_level 
* 
* Description: 	Notice：获取对应GPIO的驱动能力等级
*					     
*                
* Parameters:	gpio_num :	gpio号
*            	
...
*               -1, the parameter error.
*****************************************************************/
int ql_gpio_get_drv_level(GPIO_PIN_NUMBER_E gpio_num, QL_PIN_DRIVE_LEVEL_E *drive_level);

/*****************************************************************
* Function:     ql_peripherals_pin_not_config 
* 
* Description: Notice：设置gpio脚不配置复用功能
*                
* Parameters:
*              gpio_num 		:	gpio号
...
*               -1, the parameter error.
*****************************************************************/
int ql_peripherals_pin_not_config(GPIO_PIN_NUMBER_E gpio_num);
