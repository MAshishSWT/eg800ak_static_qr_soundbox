...
/*****************************************************************
* Function: ql_set_lwip_dns_cache_flag
*
* Description:
* 	设置DNS缓存标志。
* 
* Parameters:
* 	dns_cache	  			[in] 	是否开启DNS缓存。 
*
* Return:
* 	0			成功。
*
*****************************************************************/
extern int ql_set_lwip_dns_cache_flag(int dns_cache);

/*****************************************************************
* Function: ql_get_lwip_dns_cache_flag
*
* Description:
* 	获取DNS缓存标志。
* 
...
extern int ql_get_lwip_dns_cache_flag(void);
...
/*****************************************************************
* Function: ql_set_lwip_netif_default_by_profile_idx
*
* Description:
* 	通过profile_idx配置当前默认网卡,但是需要每次都在ql_start_data_call之前配置，才能使能。
* 
* Parameters:
* 	profile_idx	  			[in] 	PDP索引。 
*
...
*
*****************************************************************/
extern int ql_set_lwip_netif_default_by_profile_idx(int profile_idx);

/*****************************************************************
* Function: ql_get_lwip_netif_default_profile_idx
*
* Description:
* 	获取默认网卡的profile_idx。
* 
...
*
* Return:
* 	profile_idx		 	SUCCESS,PDP索引
*	0 					FAIL
*
*****************************************************************/
extern int ql_get_lwip_netif_default_profile_idx(void);
