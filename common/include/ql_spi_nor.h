...
//port
#define EXTERNAL_NORFLASH_PORT16_19        0   //SSP0
#define EXTERNAL_NORFLASH_PORT33_36_SSP0   1   //SSP0
#define EXTERNAL_NORFLASH_PORT33_36        2   //SSP2
#define EXTERNAL_NORFLASH_PORT12_15_SSP2   3   //SSP2
#define EXTERNAL_NORFLASH_PORT4_7          4   //SSP1 仅支持1602平台
...
/***********************************************************************
 *
 * Name:   ql_spi_nor_read_fifo   
 *
 * Description: 该函数用于读取SPI NOR Flash指定地址中指定长度的数据(fifo模式)。
 *
 * Parameters:  port: SPI总线,同上
 *              pBuffer: 读取的数据存储在ram中的地址
 *				ReadAddr：读取数据的flash起始地址（24位）
 ...
 *
 ***********************************************************************/
unsigned int  ql_spi_nor_read_fifo(int port, unsigned char* pBuffer,unsigned int ReadAddr,unsigned short NumByteToRead);
