...
/***********************************************************************
*
*	Name: ql_set_powerdown_threshold
*	Description: Sets the power-down voltage threshold level. This function configures the PMIC
*	to trigger system shutdown when the voltage reaches the specified threshold,
*	with 8 levels (0-7) mapping to different voltage values.
*	Parameters: level: Power-down voltage threshold level (0-7), where:
*	Level 0: 2.2V/2.1V
*	Level 1: 2.3V/2.2V
*	Level 2: 2.4V/2.3V
*	Level 3: 2.5V/2.4V
...
*	Level 7: 3.2V/3.1V
*	Returns: 0 - Success.
*	<0 - Error code (invalid level or PMIC type).
*	Notes:
*	The function checks PMIC type and only configures PMIC_807 currently
************************************************************************/

int ql_set_powerdown_threshold(int level);

//看门狗复位
void ql_watchdogReset(void);
#ifdef __cplusplus
	} /*"C" */
#endif
